...
<div v-if="showForm">
    ...
    <h2>--------------</h2>  
        <Servicecard v-for="service in services" :service_id="service.service_id" :service_name="service.service_name" :service_time="service.service_time" :service_description="service.service_description" :service_baseprice="service.service_baseprice" @serviceDeleted="removeService"></Servicecard>
    </div>
    `, 
    data(){
        return {
